...
public abstract class SymbolContainer
{
    ...
    public ImmutableArray<Symbol> Locals => Members.Where(m => m.IsLocal).ToImmutableArray();
    ...
    public ImmutableArray<Symbol> Methods => Members.Where(sym => sym.IsMethod).ToImmutableArray();

    public ImmutableArray<Symbol> Fields => Members.Where(sym => sym.IsField).ToImmutableArray();

    public ImmutableArray<Symbol> Types => Members.Where(m => m.IsType).ToImmutableArray();
    ...
    public virtual Symbol? LookupNamespace(string name) => LookupSingle(name, m => m.IsNamespace);

    public virtual Symbol? LookupVariable(string name) =>
        LookupSingle(name, m => m.IsLocal | m.IsParameter);

    public virtual Symbol? LookupField(string name) => LookupSingle(name, m => m.IsField);

    public virtual Symbol? LookupType(string name) => LookupSingle(name, m => m.IsType);
