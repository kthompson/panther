        ...
        public void ClassifierSupportsInvalidCharacters()
        {
            ...
            Assert.Collection(
                ...
                span =>
                {
                    ...
                    Assert.Equal("main", tree.Text.ToString(span.Span));
                }
            );
        }
        ...
        public void ClassifierSupportsABlock()
        {
            ...
            Assert.Collection(
                ...
                span =>
                {
                    ...
                    Assert.Equal(Environment.NewLine, tree.Text.ToString(span.Span));
                },
                span =>
                {
                    // eof token
        ...
        public void ClassifierSupportsAssignmentStatement()
        {
            ...
            Assert.Collection(
                ...
                span =>
                {
                    ...
                    Assert.Equal("val", tree.Text.ToString(span.Span));
                },
                span =>
                {
                ...
                span =>
                {
                    ...
                    Assert.Equal("x", tree.Text.ToString(span.Span));
                },
                span =>
                {
                    // = leading whitespace
                ...
                span =>
                {
                    ...
                    Assert.Equal("\"hello world\"", tree.Text.ToString(span.Span));
                },
                span =>
                {
                    // comment whitespace
                ...
                span =>
                {
                    ...
                    Assert.Equal("// tacos", tree.Text.ToString(span.Span));
                }
            );
        }
        ...
        public void ClassifierSupportsNumbers()
        {
            ...
            Assert.Collection(
                ...
                span =>
                {
                    ...
                    Assert.Equal("27", tree.Text.ToString(span.Span));
                },
                span =>
                {
                    // trailing whitespace
                ...
                span =>
                {
                    ...
                    Assert.Equal("// a number", tree.Text.ToString(span.Span));
                }
            );
        }
    }
